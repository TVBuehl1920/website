  ...
  return (
    <div className="relative isolate overflow-hidden bg-white  py-12 lg:py-12 lg:overflow-visible">
      <div className=" grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:items-start lg:gap-y-10">
        ...
        <div className="-mt-12 p-2 lg:sticky lg:top-4 lg:col-start-2 lg:row-span-2 lg:row-start-1 lg:overflow-hidden">
          {props.imageURL && (<img
            className="lazyload w-[34rem] max-w-full lg:max-w-none rounded-xl bg-gray-900 shadow-xl ring-1 ring-gray-400/10 sm:w-[39rem]"
            src={props.imageURL}
            width={624}
